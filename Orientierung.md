...
## Apartment-Skizze / Simple Apartment Plot

Stell dir vor, du stehst in deinem Wohnzimmer. So kannst du die Richtungen merken:

```text
                 Norden / North
                     ↑
                     |
Westen / West  ←  • Dein Standort  →  Osten / East
                     |
                     ↓
                 Süden / South

```
• = Du stehst hier / You are standing here

Fenster = Beobachte die Sonne / Window = Observe the sun
